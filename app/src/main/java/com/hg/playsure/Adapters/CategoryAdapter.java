...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.MyViewHolder> {
    ...
    public CategoryAdapter(Context ctx, ArrayList<MostPlayedModel> mostPlayedArray, RecyclerViewClickListener listener){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.category_adapter, parent, false);
